...
export default function CaseComponent({
  ...
  return (
    <article
      ...
      className="Case group bg-white text-black w-screen cursor-pointer md:w-[50vw] xl:w-[33.33vw] min-h-screen p-6 md:p-10 2xl:p-14 2xl:pb-0 relative flex flex-col justify-end gap-6 2xl:gap-2 transition-all duration-500 hover:text-white"
    >
      {/* Context */}
      <div
